...
<head>
  ...
  <title>Keshara FF — Free Fire Content Creator</title>
  <meta name="description" content="Keshara FF — Official website of Keshala Prasanna, Free Fire content creator. Trending videos, social links & more." />
  <meta name="theme-color" content="#000000" />

  <!-- Social preview -->
  <meta property="og:title" content="Keshara FF — Free Fire YouTube Channel" />
  <meta property="og:description" content="Watch Free Fire gameplay, tips, and highlights from Keshala Prasanna on YouTube." />
  <meta property="og:image" content="e:\YT POTOES\ProductLogo.png" />
  ...
  <style>
    ...
    * { box-sizing:border-box; margin:0; padding:0 }
    ...
    .cta { background:var(--accent); padding:10px 16px; border-radius:var(--radius); color:#fff; text-decoration:none; font-weight:700 }

    .hero { display:grid; grid-template-columns:1fr 1fr; gap:32px; align-items:center; padding:40px 0 }
    .hero h1 { font-size:36px; margin-bottom:12px }
    .hero p { color:var(--muted); margin-bottom:20px }
    .btn { display:inline-block; padding:12px 20px; border-radius:var(--radius); font-weight:700; text-decoration:none }
    ...
    .card { background:var(--card); padding:16px; border-radius:var(--radius); text-align:center }
    .card img { width:100%; max-width:220px; border-radius:var(--radius); margin:0 auto; display:block }

    footer { margin-top:60px; padding:20px 0; border-top:1px solid #222; color:var(--muted); text-align:center }
